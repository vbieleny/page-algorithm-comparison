        ...
        if (format[i] == '%')
        {
            ...
            switch (specifier)
            {
                ...
                case 'u':
                {
                    switch (length)
                    {
                        case 0:
                        {
                            ...
                            itoa_advanced(integer, int_str_buffer, base, plus_sign, space_no_sign, length_spec, left_justify, zero_pad);
                ...
                case 'G':
                {
                    ...
                    itoa_advanced(floating, int_str_buffer, base, plus_sign, space_no_sign, form,
                    ...
                    {
                        display_character(stream, '.', &chars);
                        itoa_advanced(decPlaces, int_str_buffer, 10, false, false, 0, false, false);
            ...
            {
                itoa_advanced(expo, int_str_buffer, 10, false, false, 2, false, true);
                display_string(stream, int_str_buffer, &chars);
            }
        }
        else
